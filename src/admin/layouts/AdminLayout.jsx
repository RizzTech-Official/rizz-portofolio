...
import { LayoutDashboard, Info, Briefcase, Award, Settings, Mail, LogOut, Menu, X, Sparkles, ExternalLink, Moon, Sun } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed lg:static inset-y-0 left-0 z-50 w-72 bg-gradient-to-b from-gray-900 to-gray-800 transform transition-transform duration-300 ease-out
      ...
      <div className="flex-1 flex flex-col min-h-screen lg:min-w-0">
        {/* Top bar */}
        <header className="bg-white dark:bg-gray-800 shadow-sm px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
          <div className="flex items-center gap-4">
            <button
              onClick={() => setSidebarOpen(true)}
              className="lg:hidden p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-colors"
            >
              <Menu size={24} />
            </button>
            <div className="lg:hidden flex items-center gap-2">
              ...
              <h1 className="text-lg font-bold text-gray-800 dark:text-white">RizzTech</h1>
            </div>
          </div>
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-300 transition-all shadow-sm"
