  ...
  return (
    <section id="contact" className="py-24 bg-gray-50 dark:bg-[#0a0a0a] transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-primary-600 dark:text-primary-400 font-semibold tracking-wider uppercase text-sm">Get In Touch</span>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mt-3 mb-6">Contact Us</h2>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-white/5 rounded-3xl shadow-xl dark:shadow-none border border-gray-100 dark:border-white/10 p-8 md:p-12"
        >
          {status.message && (
